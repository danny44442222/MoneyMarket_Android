...
//            conversationID = UUID.randomUUID().toString();
            ...
            FirebaseInstances.adminChatCollection.document(parcelableChat.getConversationID()).collection("Conversations").document(String.valueOf(currentTimeStamp)).set(sendConversationModel);
            FirebaseInstances.adminChatCollection.document(parcelableChat.getConversationID()).set(lasthashMap);

            loadMessages(FirebaseInstances.adminChatCollection, parcelableChat.getConversationID());
